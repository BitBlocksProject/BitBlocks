...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BitBlocks Core"),
     ...
     * override -datadir in the bitblocks.conf file in the default data directory
     * (to be consistent with bitblocksd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
