...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 60 * 40;    // BitBlocks: 40 minutes POS
        nTargetSpacing = 1 * 60;      // BitBlocks: 60 seconds POS
        nTargetTimespanPOW = 1 * 60;  // BitBlocks: 1 minute POW
        nTargetSpacingPOW = 1 * 30;   // BitBlocks: 30 seconds POW
        nLastPOWBlock = 500;
        nMaturity = 15;
...
public:
    CTestNetParams()
    {
        ...
        nTargetSpacing = 1 * 60;      // BitBlocks: 60 seconds POS
        nTargetTimespanPOW = 1 * 60;  // BitBlocks: 1 minute POW
        nTargetSpacingPOW = 1 * 60;   // BitBlocks: 1 minute POW
        nLastPOWBlock = 200;
        nMaturity = 15;
...
public:
    CRegTestParams()
    {
        ...
        nTargetTimespan = 60 * 40;     // BitBlocks: 40 minutes POS
        nTargetSpacing = 1 * 60;        // BitBlocks: 60 seconds POS
        nTargetTimespanPOW = 24 * 60 * 60; // BitBlocks: 1 day POW
        nTargetSpacingPOW = 1 * 60;     // BitBlocks: 1 minute POW
