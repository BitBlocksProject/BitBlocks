...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BitBlocks features */
        {"bitblocks", "masternode", &masternode, true, true, false},
        {"bitblocks", "listmasternodes", &listmasternodes, true, true, false},
        {"bitblocks", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bitblocks", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bitblocks", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bitblocks", "masternodedebug", &masternodedebug, true, true, false},
        {"bitblocks", "startmasternode", &startmasternode, true, true, false},
        {"bitblocks", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bitblocks", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bitblocks", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bitblocks", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bitblocks", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bitblocks", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bitblocks", "mnbudget", &mnbudget, true, true, false},
        {"bitblocks", "preparebudget", &preparebudget, true, true, false},
        {"bitblocks", "submitbudget", &submitbudget, true, true, false},
        {"bitblocks", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bitblocks", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bitblocks", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bitblocks", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bitblocks", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bitblocks", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bitblocks", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bitblocks", "checkbudgets", &checkbudgets, true, true, false},
        {"bitblocks", "mnsync", &mnsync, true, true, false},
        {"bitblocks", "spork", &spork, true, true, false},
        {"bitblocks", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"bitblocks", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    // Accept connection
    boost::shared_ptr<AcceptedConnectionImpl<Protocol> > conn(new AcceptedConnectionImpl<Protocol>(static_cast<asio::io_service&>(acceptor->get_executor().context()), context, fUseSSL));
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bitblocksd, or the -server option to bitblocks-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> bitblocks-cli " + methodname + " " + args + "\n";
}
