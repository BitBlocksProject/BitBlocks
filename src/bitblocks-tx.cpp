...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BitBlocks Core bitblocks-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bitblocks-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitblocks transaction") + "\n" +
                               "  bitblocks-tx [options] -create [commands]   " + _("Create hex-encoded bitblocks transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitblocks transaction
