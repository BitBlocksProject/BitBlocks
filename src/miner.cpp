...
bool ProcessBlockFound(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    if (!ProcessNewBlock(state, NULL, pblock))
        return error("BitBlocksMiner : ProcessNewBlock, block not accepted");
...
{
    LogPrintf("BitBlocksMiner started\n");
    ...
    while (fGenerateBitcoins || fProofOfStake) {
        ...
        LogPrintf("Running BitBlocksMiner with %u transactions in block (%u bytes)\n", pblock->vtx.size(),
