...
In order to support loading of multiple wallets in bitblocks-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bitblocks.cpp.
...
Changes to bitblocks.cpp
----------------------
bitblocks.cpp is the entry point into bitblocks-qt, and as such, will require some minor modifications to provide hooks for
